...
def test_create_user_is_successful(mock_put):
    ...
    result = rabbitmq_init.create_user(
        rabbitmq_api_base_url="dummy-rabbitmq-api-base-url",
        username="dummy_user",
        password="dummy_pwd",
        role="dummy_role",
...
def test_set_resource_permissions_is_successful(mock_put):
    response.status_code = 201
    mock_put.return_value = response
    result = rabbitmq_init.set_resource_permissions(
        rabbitmq_api_base_url="dummy-rabbitmq-api-base-url",
        v_host="dummy_v_host",
        username="dummy_username",
        configure_resources_regex="dummy_regex",
...
def test_set_topic_permissions_is_successful(mock_put):
    response.status_code = 201
    mock_put.return_value = response
    result = rabbitmq_init.set_topic_permissions(
        rabbitmq_api_base_url="dummy-rabbitmq-api-base-url",
        v_host="dummy_v_host",
        username="dummy_username",
...
def test_create_queue_user_and_set_permission(
    ...
    mock_set_resource_permissions.assert_called_once_with(
        rabbitmq_api_base_url="dummy-rabbitmq-api-base-url",
        v_host="vhost",
