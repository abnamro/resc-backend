...
class TestRules(unittest.TestCase):
    def setUp(self):
        ...
        self.db_status_count = sorted(
            self.db_status_count, key=lambda status_count: status_count[1]
        )
    ...
    @patch(
        "resc_backend.resc_web_service.crud.finding.get_distinct_rules_from_findings"
    )
    def test_get_distinct_rules_from_findings_by_single_finding_status(
        self, get_distinct_rules_from_findings
    ):
    ...
    def test_get_distinct_rules_from_findings_by_multiple_finding_status(
        self, get_distinct_rules_from_findings
    ):
        get_distinct_rules_from_findings.return_value = self.db_rules
        with self.client as client:
    ...
    def test_get_distinct_rules_from_findings_by_single_vcs_provider(
        self, get_distinct_rules_from_findings
    ):
        get_distinct_rules_from_findings.return_value = self.db_rules
        with self.client as client:
    ...
    def test_get_distinct_rules_from_findings_by_multiple_vcs_provider(
        self, get_distinct_rules_from_findings
    ):
        get_distinct_rules_from_findings.return_value = self.db_rules
        with self.client as client:
    ...
    def test_get_distinct_rules_from_findings_by_project_name(
        self, get_distinct_rules_from_findings
    ):
    ...
    def test_get_distinct_rules_from_findings_by_repository_name(
        self, get_distinct_rules_from_findings
    ):
    ...
    def test_get_distinct_rules_from_findings_by_start_date(
        self, get_distinct_rules_from_findings
    ):
    ...
    def test_get_distinct_rules_from_findings_by_end_date(
        self, get_distinct_rules_from_findings
    ):
    ...
    def test_get_distinct_rules_from_findings_by_rule_pack_version(
        self, get_distinct_rules_from_findings
    ):
    ...
    def test_get_distinct_rules_from_findings_when_all_filters_selected(
        self, get_distinct_rules_from_findings
    ):
        project_name = "Test_Project"
        repository_name = "Test_Repository"
    ...
    def test_get_distinct_rules_from_findings_when_no_filter_selected(
        self, get_distinct_rules_from_findings
    ):
        get_distinct_rules_from_findings.return_value = self.db_rules
        with self.client as client:
            ...
            # Make the second request to retrieve response from cache
            cached_response = client.get(
                f"{RWS_VERSION_PREFIX}" f"{RWS_ROUTE_DETECTED_RULES}"
            )
            self.assert_cache(cached_response)
            assert response.json() == cached_response.json()

    @patch(
        "resc_backend.resc_web_service.crud.finding.get_rule_findings_count_by_status"
    )
    def test_get_rules_finding_status_count(self, get_rule_findings_count_by_status):
        rule_statuses = {
            self.db_rules[0].rule_name: {
                "true_positive": 2,
                "false_positive": 2,
                "not_analyzed": 2,
                "under_review": 2,
    ...
    def test_get_rules_finding_status_count_with_valid_rule_pack_filter(
        self, get_rule_findings_count_by_status
    ):
    ...
    def test_get_rules_finding_status_count_with_multiple_rule_pack_filter(
        self, get_rule_findings_count_by_status
    ):
        version1 = "1.0.1"
        version2 = "1.0.2"
    ...
    def test_get_rules_finding_status_count_with_invalid_rule_pack_filter(
        self, get_rule_findings_count_by_status
    ):
